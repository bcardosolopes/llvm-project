...
// CIR: cir.func {{.*}} @_ZN1BD1Ev(!cir.ptr<!rec_B>) alias(@_ZN1BD2Ev) special_member<#cir.cxx_dtor<!rec_B>>
...
// CIR: cir.func {{.*}} @_ZN1CD1Ev(!cir.ptr<!rec_C>) alias(@_ZN1CD2Ev) special_member<#cir.cxx_dtor<!rec_C>>

// CIR_O1-NOT: cir.func {{.*}} @_ZN1CD2Ev(%arg0: !cir.ptr<!rec_C>{{.*}}) {{.*}} {
// CIR_O1: cir.func private dso_local @_ZN1CD2Ev(!cir.ptr<!rec_C>) alias(@_ZN1BD2Ev) special_member<#cir.cxx_dtor<!rec_C>>
// CIR_O1: cir.func private dso_local @_ZN1CD1Ev(!cir.ptr<!rec_C>) alias(@_ZN1CD2Ev) special_member<#cir.cxx_dtor<!rec_C>>
