...
// CHECK-NEXT: cir.global external @a = #cir.ptr<null> : !cir.ptr<!rec_A> {alignment = 8 : i64}
...
// CHECK-NEXT: }
// CHECK: cir.global "private" internal @_ZGR1a_ : !rec_A {alignment = 1 : i64}
// CHECK: cir.func {{.*}} @_GLOBAL__sub_I_tempref.cpp() {
// CHECK-NEXT:   cir.call @__cxx_global_var_init() : () -> ()
// CHECK-NEXT:   cir.return
// CHECK-NEXT: }

// LLVM-DAG: @_ZGR1a_ = internal global %struct.A undef{{.*}}
// LLVM-DAG: @a = global ptr null, align 8
// LLVM-DAG: @llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_tempref.cpp, ptr null }]
