...
// CIR: cir.func {{.*}} @_ZSt1fIPKcEvSt16initializer_listIT_E(%arg0: !cir.array<!u64i x 2>
...
// CIR: [[NEXT_ELEM_PTR:%.*]] = cir.ptr_stride [[FIRST_ELEM_PTR]], [[ONE]] : (!cir.ptr<!cir.ptr<!s8i>>, !s64i) -> !cir.ptr<!cir.ptr<!s8i>>
...
// CIR: [[ARG_LOAD:%.*]] = cir.load{{.*}} [[INITLIST_LOCAL]] : !cir.ptr<[[INITLIST_TYPE]]>, [[INITLIST_TYPE]]
// CIR: [[BITCAST:%.*]] = cir.cast bitcast [[INITLIST_LOCAL]] : !cir.ptr<[[INITLIST_TYPE]]> -> !cir.ptr<!cir.array<!u64i x 2>>
// CIR: [[FLAT_ARG:%.*]] = cir.load [[BITCAST]] : !cir.ptr<!cir.array<!u64i x 2>>, !cir.array<!u64i x 2>
// CIR: cir.call @_ZSt1fIPKcEvSt16initializer_listIT_E([[FLAT_ARG]]) : (!cir.array<!u64i x 2>) -> ()
// CIR: }
// CIR: cir.return
// CIR: }
