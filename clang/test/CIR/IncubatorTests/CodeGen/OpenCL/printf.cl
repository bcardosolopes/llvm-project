...
// CIR-FP64: %{{.+}} = cir.call @printf(%{{.+}}, %{{.+}}) nothrow : (!cir.ptr<!s8i, lang_address_space(offload_constant)>, !cir.vector<2 x !cir.float>) -> !s32i cc(spir_function)
// CIR-NOFP64:%{{.+}} = cir.call @printf(%{{.+}}, %{{.+}}) nothrow : (!cir.ptr<!s8i, lang_address_space(offload_constant)>, !cir.vector<2 x !cir.float>) -> !s32i cc(spir_function)
...
// CIR-FP64: %{{.+}} = cir.call @printf(%{{.+}}, %{{.+}}) nothrow : (!cir.ptr<!s8i, lang_address_space(offload_constant)>, !cir.vector<2 x !cir.f16>) -> !s32i cc(spir_function)
// CIR-NOFP64:%{{.+}} = cir.call @printf(%{{.+}}, %{{.+}}) nothrow : (!cir.ptr<!s8i, lang_address_space(offload_constant)>, !cir.vector<2 x !cir.f16>) -> !s32i cc(spir_function)
...
// CIR-FP64: %{{.+}} = cir.call @printf(%{{.+}}, %{{.+}}) nothrow : (!cir.ptr<!s8i, lang_address_space(offload_constant)>, !cir.vector<2 x !cir.double>) -> !s32i cc(spir_function)
