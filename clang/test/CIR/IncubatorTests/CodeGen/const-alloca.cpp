...
// LLVM-NEXT: store i32 %[[#INIT]], ptr %[[#SLOT:]], align 4
// LLVM-NEXT: %{{.+}} = load i32, ptr %[[#SLOT]], align 4
// LLVM: }
...
// LLVM-NEXT:    %{{.+}} = load i32, ptr %[[#x_slot]], align 4
// LLVM-NEXT:    ret i32 %{{.+}}
// LLVM-NEXT:  }
...
//      LLVM:    %[[#init:]] = call i32 @_Z11produce_intv()
// LLVM-NEXT:    store i32 %[[#init]], ptr %{{.+}}, align 4
// LLVM-NEXT:    call void @_Z8blackboxRKi(ptr nonnull %{{.+}})
// LLVM-NEXT:    %{{.+}} = load i32, ptr %{{.+}}, align 4
// LLVM-NEXT:    call void @_Z7consumei(i32 %{{.+}})
//      LLVM:  }
