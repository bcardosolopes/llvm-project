...
// BEFORE:    %[[COOKIE_PTR:.*]] = cir.cast bitcast %[[PTR_AS_U8]] : !cir.ptr<!u8i> -> !cir.ptr<!u64i>
...
// BEFORE:    %[[OBJ_VOID_PTR:.*]] = cir.cast bitcast %[[OBJ_PTR]] : !cir.ptr<!u8i> -> !cir.ptr<!void>
// BEFORE:    %[[OBJ_ELEM_PTR:.*]] = cir.cast bitcast %[[OBJ_VOID_PTR]] : !cir.ptr<!void> -> !cir.ptr<!rec_E>
...
// AFTER:    %[[COOKIE_PTR:.*]] = cir.cast bitcast %[[PTR_AS_U8]] : !cir.ptr<!u8i> -> !cir.ptr<!u64i>
...
// AFTER:    %[[OBJ_VOID_PTR:.*]] = cir.cast bitcast %[[OBJ_PTR]] : !cir.ptr<!u8i> -> !cir.ptr<!void>
// AFTER:    %[[OBJ_ELEM_PTR:.*]] = cir.cast bitcast %[[OBJ_VOID_PTR]] : !cir.ptr<!void> -> !cir.ptr<!rec_E>
...
// AFTER:    %[[ELEM_PTR:.*]] = cir.cast array_to_ptrdecay %[[OBJ_ARRAY_PTR]] : !cir.ptr<!cir.array<!rec_E x 3>> -> !cir.ptr<!rec_E>
...
// AFTER:      %[[OFFSET2:.*]] = cir.const #cir.int<1> : !u64i
// AFTER:      %[[NEXT_PTR:.*]] = cir.ptr_stride %[[CUR_ELEM_PTR]], %[[OFFSET2]] : (!cir.ptr<!rec_E>, !u64i) -> !cir.ptr<!rec_E>
