...
// CIR-DAG: cir.global external @globalVar = #cir.int<123> : !s32i
...
// CIR-DAG: cir.global external @globalArray = #cir.const_array<[#cir.int<1> : !s32i, #cir.int<2> : !s32i, #cir.int<3> : !s32i, #cir.int<4> : !s32i]> : !cir.array<!s32i x 4>
...
// CIR-DAG: cir.global "private" internal{{.*}} @_ZL12staticGlobal = #cir.int<555> : !s32i
...
// CIR-DAG: cir.global constant external @constGlobal = #cir.int<456> : !s32i
...
// CIR-DAG: cir.global constant external @constArray = #cir.const_array<[#cir.int<10> : !s32i, #cir.int<20> : !s32i, #cir.int<30> : !s32i]> : !cir.array<!s32i x 3>
