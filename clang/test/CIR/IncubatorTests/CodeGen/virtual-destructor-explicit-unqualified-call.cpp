...
A A::B(A) {
  ...
  // CIR-SAME:      %arg1: !cir.ptr<!rec_A>
  // CIR-SAME:      %arg2: !cir.ptr<!rec_A>
  // CIR:           %[[THIS_VAR:.*]] = cir.alloca !cir.ptr<!rec_A>, !cir.ptr<!cir.ptr<!rec_A>>
  // CIR:           cir.store %arg1, %[[THIS_VAR]] : !cir.ptr<!rec_A>, !cir.ptr<!cir.ptr<!rec_A>>
  ...
  // LLVM-LABEL:   define dso_local void @_ZN1A1BES_(
  // LLVM-SAME:      ptr %{{[0-9]+}},
