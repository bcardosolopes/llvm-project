...
void vector_int_test(int x) {
  ...
  // Vector constant.
  vi4 a = { 1, 2, 3, 4 };
  // CIR: %{{[0-9]+}} = cir.const #cir.const_vector<[#cir.int<1> : !s32i, #cir.int<2> : !s32i, #cir.int<3> : !s32i, #cir.int<4> : !s32i]> : !cir.vector<4 x !s32i>
...
void vector_double_test(int x, double y) {
  // Vector constant.
  vd2 a = { 1.5, 2.5 };
  // CIR: %{{[0-9]+}} = cir.const #cir.const_vector<[#cir.fp<1.500000e+00> : !cir.double, #cir.fp<2.500000e+00> : !cir.double]> : !cir.vector<2 x !cir.double>
...
void test_vec3() {
  ...
  // CIR-NEXT: %[[#VVAL:]] = cir.const #cir.const_vector<[#cir.int<0> : !s32i, #cir.int<0> : !s32i, #cir.int<0> : !s32i]> : !cir.vector<3 x !s32i>
  // CIR-NEXT: cir.store{{.*}} %[[#VVAL]], %[[#PV]] : !cir.vector<3 x !s32i>, !cir.ptr<!cir.vector<3 x !s32i>>
