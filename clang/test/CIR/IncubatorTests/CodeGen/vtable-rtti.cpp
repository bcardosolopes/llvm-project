...
// B's vtable is now fully emitted; A's is still external (undefined dtor).
// CHECK-DAG: cir.global{{.*}}linkonce_odr comdat  @_ZTV1B = #cir.vtable
// CHECK-DAG: cir.global "private"  external @_ZTV1A : !rec_anon_struct
// RTTI_DISABLED-DAG: cir.global{{.*}}linkonce_odr comdat  @_ZTV1B = #cir.vtable
...
// With -fno-rtti, no RTTI globals should be emitted.
