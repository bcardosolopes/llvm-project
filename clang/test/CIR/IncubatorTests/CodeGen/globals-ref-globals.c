...
// CHECK-DAG: g2 = #cir.const_array<[#cir.global_view<@g1, [4 : i32]> : !cir.ptr<!rec_anon_struct>, #cir.global_view<@g1, [4 : i32]> : !cir.ptr<!rec_anon_struct>, #cir.global_view<@g1, [4 : i32]> : !cir.ptr<!rec_anon_struct>, #cir.global_view<@g1, [4 : i32]> : !cir.ptr<!rec_anon_struct>]> : !cir.array<!cir.ptr<!s32i> x 4>
...
// CHECK-DAG: g7 = #cir.const_array<[#cir.global_view<@g6, [0 : i32, 5 : i32]> : !cir.ptr<!s32i>, #cir.global_view<@g6, [1 : i32, 5 : i32]> : !cir.ptr<!s32i>]> : !cir.array<!cir.ptr<!s32i> x 2>
...
// CHECK-DAG: g13 = #cir.const_record<{#cir.int<-1> : !s16i
// g14 CHECK is already covered by the CHECK-DAG on line 32.
...
// CHECK-DAG: g16 = #cir.global_view<@g15, [8 : i32, 1 : i32]> : !cir.ptr<!rec_anon_struct2> {alignment = 8 : i64}
