...
// CIR:       cir.call exception @_ZNSt6vectorIPKcE9push_backEOS1_(%arg0, %[[REF_TMP]]) : (!cir.ptr<![[VEC]]>, !cir.ptr<!cir.ptr<!s8i>>) -> ()
// CIR:       cir.yield
// CIR:     } unwind {
// CIR:       cir.resume
// CIR:     }
...
// CIR:   cir.if %[[NOT_NRVO]] {
// CIR:     cir.call @_ZNSt6vectorIPKcED1Ev(%arg0) {{.*}}: (!cir.ptr<!rec_std3A3Avector3Cconst_char_2A3E>) -> ()
// CIR:   }
// CIR:   cir.return
