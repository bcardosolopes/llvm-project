...
// Vtable and VTT globals are fully emitted (A's vtable is external: dtor not defined)
// CIR-DAG: cir.global  linkonce_odr comdat @_ZTV1D = #cir.vtable
// CIR-DAG: cir.global  linkonce_odr comdat @_ZTT1D = #cir.const_array
// CIR-DAG: cir.global  linkonce_odr comdat @_ZTV1A = #cir.vtable
...
// LLVM:   %[[THIS:.*]] = load ptr, ptr %{{.*}}, align 8
