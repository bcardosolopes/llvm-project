...
void test_mm512_mask_storeu_epi8(void *__P, __mmask64 __U, __m512i __A) {
  ...
  // CIR: %{{.*}} = cir.call_llvm_intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<64 x {{!s8i|!u8i}}>, !cir.ptr<!cir.vector<64 x {{!s8i|!u8i}}>>, !u32i, !cir.vector<64 x !cir.int<s, 1>>) -> !void
...
__m512i test_mm512_mask_loadu_epi8(__m512i __W, __mmask64 __U, void const *__P) {
  ...
  // CIR: %{{.*}} = cir.call_llvm_intrinsic "masked.load" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.ptr<!cir.vector<64 x {{!s8i|!u8i}}>>, !u32i, !cir.vector<64 x !cir.int<s, 1>>, !cir.vector<64 x {{!s8i|!u8i}}>) -> !cir.vector<64 x {{!s8i|!u8i}}>
...
__mmask64 test_mm512_movepi8_mask(__m512i __A) {
  ...
  // CIR: %{{.*}} = cir.vec.cmp(lt, %{{.*}}, %{{.*}}) : !cir.vector<64 x {{!s8i|!u8i}}>, !cir.vector<64 x !cir.int<s, 1>>
...
__mmask32 test_mm512_movepi16_mask(__m512i __A) {
  ...
  // CIR: %{{.*}} = cir.vec.cmp(lt, %{{.*}}, %{{.*}}) : !cir.vector<32 x !s16i>, !cir.vector<32 x !cir.int<s, 1>>
