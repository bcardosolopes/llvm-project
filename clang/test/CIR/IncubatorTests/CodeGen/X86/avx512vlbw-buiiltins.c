...
void test_mm_mask_storeu_epi8(void *__P, __mmask16 __U, __m128i __A) {
  ...
  // CIR: %{{.*}} = cir.call_llvm_intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<{{!s8i|!u8i}} x 16>, !cir.ptr<!cir.vector<{{!s8i|!u8i}} x 16>>, !u32i, !cir.vector<16 x !cir.int<s, 1>>)
...
void test_mm256_mask_storeu_epi8(void *__P, __mmask32 __U, __m256i __A) {
  ...
  // CIR: %{{.*}} = cir.call_llvm_intrinsic "masked.store" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.vector<{{!s8i|!u8i}} x 32>, !cir.ptr<!cir.vector<{{!s8i|!u8i}} x 32>>, !u32i, !cir.vector<32 x !cir.int<s, 1>>) -> !void
...
__m128i test_mm_movm_epi8(__mmask16 __A) {
  ...
  // CIR: %{{.*}} = cir.cast integral %{{.*}} : !cir.vector<16 x !cir.int<s, 1>> -> !cir.vector<{{!s8i|!u8i}} x 16>
...
__m256i test_mm256_movm_epi8(__mmask32 __A) {
  ...
  // CIR: %{{.*}} = cir.cast integral %{{.*}} : !cir.vector<32 x !cir.int<s, 1>> -> !cir.vector<{{!s8i|!u8i}} x 32>
...
__m512i test_mm512_movm_epi8(__mmask64 __A) {
  ...
  // CIR: %{{.*}} = cir.cast integral %{{.*}} : !cir.vector<64 x !cir.int<s, 1>> -> !cir.vector<{{!s8i|!u8i}} x 64>
...
__m128i test_mm_mask_loadu_epi8(__m128i __W, __mmask16 __U, void const *__P) {
  ...
  // CIR: cir.call_llvm_intrinsic "masked.load" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.ptr<!cir.vector<{{!s8i|!u8i}} x 16>>, !u32i, !cir.vector<16 x !cir.int<s, 1>>, !cir.vector<{{!s8i|!u8i}} x 16>) -> !cir.vector<{{!s8i|!u8i}} x 16>
...
__m256i test_mm256_mask_loadu_epi8(__m256i __W, __mmask32 __U, void const *__P) {
  ...
  // CIR: cir.call_llvm_intrinsic "masked.load" %{{.*}}, %{{.*}}, %{{.*}}, %{{.*}} : (!cir.ptr<!cir.vector<{{!s8i|!u8i}} x 32>>, !u32i, !cir.vector<32 x !cir.int<s, 1>>, !cir.vector<{{!s8i|!u8i}} x 32>) -> !cir.vector<{{!s8i|!u8i}} x 32>
...
__mmask16 test_mm_movepi8_mask(__m128i __A) {
  ...
  // CIR: %{{.*}} = cir.vec.cmp(lt, %{{.*}}, %{{.*}}) : !cir.vector<{{!s8i|!u8i}} x 16>, !cir.vector<16 x !cir.int<u, 1>>
...
__mmask16 test_mm256_movepi16_mask(__m256i __A) {
  ...
  // CIR: %{{.*}} = cir.vec.cmp(lt, %{{.*}}, %{{.*}}) : !cir.vector<16 x !s16i>, !cir.vector<16 x !cir.int<u, 1>>
