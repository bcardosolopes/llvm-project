...
// CIR-DAG: cir.global "private"{{.*}}constant internal @_ZGR1r_ = #cir.int<1234> : !s32i
// CIR-DAG: cir.global{{.*}}constant external @r = #cir.global_view<@_ZGR1r_> : !cir.ptr<!s32i> {alignment = 8 : i64}

//      CIR: cir.func private @_ZN1EntEv(!cir.ptr<!rec_E>) -> !u8i
...
// CIR-NEXT:     %[[THREE:[0-9]+]] = cir.call @_ZN1EntEv(%[[TWO]]) : (!cir.ptr<!rec_E>) -> !u8i
// CIR-NEXT:     %[[FOUR:[0-9]+]] = cir.cast bitcast %[[ONE]] : !cir.ptr<!rec_E> -> !cir.ptr<!u8i>
// CIR-NEXT:     cir.store %[[THREE]], %[[FOUR]] : !u8i, !cir.ptr<!u8i>
// CIR-NEXT:     cir.call @_ZN1ED1Ev(%[[ONE]]) nothrow : (!cir.ptr<!rec_E>) -> ()
// CIR-NEXT:     cir.call @_ZN1ED1Ev(%[[TWO]]) nothrow : (!cir.ptr<!rec_E>) -> ()
// CIR-NEXT:   }
// CIR-NEXT:   cir.return
// CIR-NEXT: }
...
// CIR_EH: cir.call exception @_ZN1EntEv
// CIR_EH: cir.store
// CIR_EH: cir.yield
// CIR_EH: } unwind {
// CIR_EH: cir.resume
