...
// CHECK-LABEL: func.func @testfunc
...
// CHECK: memref.store %{{.*}}, %[[ALLOCA_S]][{{%c0[^ ]*}}] : memref<1xi16>
// CHECK: memref.store %{{.*}}, %[[ALLOCA_X]][{{%c0[^ ]*}}] : memref<1xf32>
// CHECK: memref.store %{{.*}}, %[[ALLOCA_C]][{{%c0[^ ]*}}] : memref<1xi8>
// CHECK: memref.store %{{.*}}, %[[ALLOCA_LL]][{{%c0[^ ]*}}] : memref<1xi64>
// CHECK: memref.store %{{.*}}, %[[ALLOCA_I]][{{%c0[^ ]*}}] : memref<1xi32>
// CHECK: memref.store %{{.*}}, %[[ALLOCA_D]][{{%c0[^ ]*}}] : memref<1xf64>
...
// CHECK: %[[S:.*]] = memref.load %[[ALLOCA_S]][{{%c0[^ ]*}}] : memref<1xi16>
// CHECK: %[[S_EXT:.*]] = arith.extsi %[[S]] : i16 to i32
// CHECK: %[[X:.*]] = memref.load %[[ALLOCA_X]][{{%c0[^ ]*}}] : memref<1xf32>
// CHECK: %[[X_EXT:.*]] = arith.extf %[[X]] : f32 to f64
// CHECK: %[[C:.*]] = memref.load %[[ALLOCA_C]][{{%c0[^ ]*}}] : memref<1xi8>
// CHECK: %[[C_EXT:.*]] = arith.extsi %[[C]] : i8 to i32
// CHECK: %[[LL:.*]] = memref.load %[[ALLOCA_LL]][{{%c0[^ ]*}}] : memref<1xi64>
// CHECK: %[[I:.*]] = memref.load %[[ALLOCA_I]][{{%c0[^ ]*}}] : memref<1xi32>
// CHECK: %[[D:.*]] = memref.load %[[ALLOCA_D]][{{%c0[^ ]*}}] : memref<1xf64>
