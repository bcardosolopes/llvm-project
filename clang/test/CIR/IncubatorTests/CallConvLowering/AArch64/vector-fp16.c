...
// CIR: cir.func {{.*}} @test_float4(%arg0: !cir.vector<4 x !cir.float> {{.*}}) -> !cir.vector<4 x !cir.float>
...
// CIR: cir.func {{.*}} @test_float4_add(%arg0: !cir.vector<4 x !cir.float> {{.*}}, %arg1: !cir.vector<4 x !cir.float> {{.*}}) -> !cir.vector<4 x !cir.float>
...
// CIR: cir.func {{.*}} @test_int4(%arg0: !cir.vector<4 x !s32i> {{.*}}) -> !cir.vector<4 x !s32i>
...
// CIR: cir.func {{.*}} @test_int4_add(%arg0: !cir.vector<4 x !s32i> {{.*}}, %arg1: !cir.vector<4 x !s32i> {{.*}}) -> !cir.vector<4 x !s32i>
...
// CIR: cir.func {{.*}} @test_half4(%arg0: !cir.vector<4 x !cir.f16> {{.*}}) -> !cir.vector<4 x !cir.f16>
...
// CIR: cir.func {{.*}} @test_half4_add(%arg0: !cir.vector<4 x !cir.f16> {{.*}}, %arg1: !cir.vector<4 x !cir.f16> {{.*}}) -> !cir.vector<4 x !cir.f16>
