...
void test_move_after_copy_ctor() {
  ...
  // CHECK:           cir.call @_ZN1AC2EOS_(%[[VAR_B]], %[[VAR_A]])
  // CHECK:           cir.call @_ZN1AC1EOS_(%[[VAR_C]], %{{.*}})
  // CHECK:         }
...
void test_move_after_copy_assign() {
  ...
  // CHECK:           %[[VAR_B:.*]] = cir.alloca !rec_A
  // CHECK:           %[[VAR_C:.*]] = cir.alloca !rec_A
  // CHECK:           %[[VAL_3:.*]] = cir.call @_ZN1AaSEOS_(%[[VAR_B]], %[[VAR_A]])
  // CHECK:           %[[VAL_4:.*]] = cir.call @_ZN1AaSEOS_(%[[VAR_C]], %{{.*}})
  // CHECK:           cir.return
  // CHECK:         }
