//===- SCFPrepare.cpp - preparation work for SCF lowering -----------------===//
//
...
namespace mlir {
#define GEN_PASS_DEF_SCFPREPARE
...
struct CanonicalizeIVtoCmpLHS : public OpRewritePattern<ForOp> {
  ...
  void replaceWithNewCmpOp(CmpOp oldCmp, CmpOpKind newKind, Value lhs,
    ...
    auto newCmp = cir::CmpOp::create(rewriter, oldCmp.getLoc(), newKind, lhs,
                                     rhs);
...
struct SCFPreparePass : public impl::SCFPrepareBase<SCFPreparePass> {
